...
export const ContainerScroll = ({
  ...
  const rotate = useTransform(scrollYProgress, [0, 1], [35, 8]);  // More tilt: start at 35deg, end at 8deg
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-2 border-border/60 p-3 md:p-8 bg-card rounded-[30px] shadow-2xl"
    >
